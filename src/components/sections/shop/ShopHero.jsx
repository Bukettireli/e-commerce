...
function ShopHero() {
    const categories = [
        { id: 1, name: 'CLOTHS', items: 5, image: '/images/shop1.jpg' },
        { id: 2, name: 'CLOTHS', items: 5, image: '/images/shop2.jpg' },
        { id: 3, name: 'CLOTHS', items: 5, image: '/images/shop3.jpg' },
        { id: 4, name: 'CLOTHS', items: 5, image: '/images/shop4.jpg' },
        { id: 5, name: 'CLOTHS', items: 5, image: '/images/shop5.jpg' },
    ];
